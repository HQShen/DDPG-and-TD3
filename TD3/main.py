import gym
import torch
from utils import tic, toc, show_result
...
parser.add_argument('--critic_lr', type=float, default=1e-3, metavar='N',
...
a = tic()
td3_object.train(args.num_steps)
b = toc(a)
...
evaluate_policy(env, td3_object.actor)